...
public class RenderBlocksMeta
{
    /**
     * Renders a standard cube block at the given coordinates
     */
    public boolean renderStandardBlock(RenderBlocks renderer, Block par1Block, int meta, int x, int y, int z)
    {
        int l = par1Block.colorMultiplier(renderer.blockAccess, x, y, z);
        ...
        return Minecraft.isAmbientOcclusionEnabled() && Block.lightValue[par1Block.blockID] == 0 ? (renderer.partialRenderBounds ? this.func_102027_b(renderer,
        		par1Block, meta, x, y, z, f, f1, f2) : this.renderStandardBlockWithAmbientOcclusion(renderer, par1Block, meta, x, y, z, f, f1, f2))
        		: this.renderStandardBlockWithColorMultiplier(renderer, par1Block, meta, x, y, z, f, f1, f2);
    }
    
    public boolean func_102027_b(RenderBlocks renderer, Block par1Block, int meta, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 - 1, par4, 0))
        {
            ...
            renderer.renderFaceYNeg(par1Block, (double)par2, (double)par3, (double)par4, renderer.getBlockIconFromSideAndMetadata(par1Block, 0, meta));
            flag = true;
        }
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 + 1, par4, 1))
        {
            ...
            renderer.colorGreenTopRight *= f6;
            renderer.colorBlueTopRight *= f6;
            renderer.renderFaceYPos(par1Block, (double)par2, (double)par3, (double)par4, renderer.getBlockIconFromSideAndMetadata(par1Block, 1, meta));
            flag = true;
        }
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 - 1, 2))
        {
            ...
            renderer.colorGreenTopRight *= f6;
            renderer.colorBlueTopRight *= f6;
            icon = renderer.getBlockIconFromSideAndMetadata(par1Block, 2, meta);
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 + 1, 3))
        {
            ...
            renderer.colorGreenTopRight *= f6;
            renderer.colorBlueTopRight *= f6;
            icon = renderer.getBlockIconFromSideAndMetadata(par1Block, 3, meta);
            renderer.renderFaceXNeg(par1Block, (double)par2, (double)par3, (double)par4, renderer.getBlockIcon(par1Block, renderer.blockAccess, par2, par3, par4, 3));
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 - 1, par3, par4, 4))
        {
            ...
            renderer.colorGreenTopRight *= f6;
            renderer.colorBlueTopRight *= f6;
            icon = renderer.getBlockIconFromSideAndMetadata(par1Block, 4, meta);
        ...
        if (renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 + 1, par3, par4, 5))
        {
            ...
            renderer.colorGreenTopRight *= f6;
            renderer.colorBlueTopRight *= f6;
            icon = renderer.getBlockIconFromSideAndMetadata(par1Block, 5, meta);
    ...
    public boolean renderStandardBlockWithAmbientOcclusion(RenderBlocks renderer, Block par1Block, int meta, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        renderer.enableAO = true;
        boolean flag = false;
        float f3 = 0.0F;
	 ...
	 */
    public boolean renderStandardBlockWithColorMultiplier(RenderBlocks renderer, Block par1Block, int meta, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        renderer.enableAO = false;
        Tessellator tessellator = Tessellator.instance;
        boolean flag = false;
