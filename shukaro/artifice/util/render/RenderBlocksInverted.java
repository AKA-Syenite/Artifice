...
public class RenderBlocksInverted
{
	...
	public boolean func_102027_b(RenderBlocks renderer, Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
	{
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 - 1, par4, 0) && !connectBottom)
		{
			...
			this.renderFaceYNeg(renderer, par1Block, (double) par2, (double) par3, (double) par4,
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3 + 1, par4, 1) && !connectTop)
		{
			...
			renderer.colorGreenTopRight *= f6;
			renderer.colorBlueTopRight *= f6;
			this.renderFaceYPos(renderer, par1Block, (double) par2, (double) par3, (double) par4,
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 - 1, 2) && !connectEast)
		{
			...
			f3 = (float) ((double) f9 * renderer.renderMaxY * (1.0D - renderer.renderMinX) + (double) f8 * renderer.renderMinY * renderer.renderMinX
					+ (double) f11 * (1.0D - renderer.renderMaxY) * renderer.renderMinX + (double) f10 * (1.0D - renderer.renderMaxY)
					* (1.0D - renderer.renderMinX));
			f4 = (float) ((double) f9 * renderer.renderMaxY * (1.0D - renderer.renderMaxX) + (double) f8 * renderer.renderMaxY * renderer.renderMaxX
					+ (double) f11 * (1.0D - renderer.renderMaxY) * renderer.renderMaxX + (double) f10 * (1.0D - renderer.renderMaxY)
					* (1.0D - renderer.renderMaxX));
			f5 = (float) ((double) f9 * renderer.renderMinY * (1.0D - renderer.renderMaxX) + (double) f8 * renderer.renderMinY * renderer.renderMaxX
					+ (double) f11 * (1.0D - renderer.renderMinY) * renderer.renderMaxX + (double) f10 * (1.0D - renderer.renderMinY)
					* (1.0D - renderer.renderMaxX));
			f6 = (float) ((double) f9 * renderer.renderMinY * (1.0D - renderer.renderMinX) + (double) f8 * renderer.renderMinY * renderer.renderMinX
					+ (double) f11 * (1.0D - renderer.renderMinY) * renderer.renderMinX + (double) f10 * (1.0D - renderer.renderMinY)
					* (1.0D - renderer.renderMinX));
			...
			this.renderFaceXPos(renderer, par1Block, (double) par2, (double) par3, (double) par4, icon);
			...
			if(RenderBlocks.fancyGrass && icon.getIconName().equals("grass_side") && !renderer.hasOverrideBlockTexture())
			{
				...
				this.renderFaceXPos(renderer, par1Block, (double) par2, (double) par3, (double) par4, BlockGrass.getIconSideOverlay());
			}
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 + 1, 3) && !connectWest)
		{
			...
			f3 = (float) ((double) f9 * renderer.renderMaxY * (1.0D - renderer.renderMinX) + (double) f8 * renderer.renderMaxY * renderer.renderMinX
					+ (double) f11 * (1.0D - renderer.renderMaxY) * renderer.renderMinX + (double) f10 * (1.0D - renderer.renderMaxY)
					* (1.0D - renderer.renderMinX));
			f4 = (float) ((double) f9 * renderer.renderMinY * (1.0D - renderer.renderMinX) + (double) f8 * renderer.renderMinY * renderer.renderMinX
					+ (double) f11 * (1.0D - renderer.renderMinY) * renderer.renderMinX + (double) f10 * (1.0D - renderer.renderMinY)
					* (1.0D - renderer.renderMinX));
			f5 = (float) ((double) f9 * renderer.renderMinY * (1.0D - renderer.renderMaxX) + (double) f8 * renderer.renderMinY * renderer.renderMaxX
					+ (double) f11 * (1.0D - renderer.renderMinY) * renderer.renderMaxX + (double) f10 * (1.0D - renderer.renderMinY)
					* (1.0D - renderer.renderMaxX));
			f6 = (float) ((double) f9 * renderer.renderMaxY * (1.0D - renderer.renderMaxX) + (double) f8 * renderer.renderMaxY * renderer.renderMaxX
					+ (double) f11 * (1.0D - renderer.renderMaxY) * renderer.renderMaxX + (double) f10 * (1.0D - renderer.renderMaxY)
					* (1.0D - renderer.renderMaxX));
			...
			this.renderFaceXNeg(renderer, par1Block, (double) par2, (double) par3, (double) par4,
			...
			if(RenderBlocks.fancyGrass && icon.getIconName().equals("grass_side") && !renderer.hasOverrideBlockTexture())
			{
				...
				renderer.colorBlueBottomRight *= par7;
				renderer.colorBlueTopRight *= par7;
				this.renderFaceXNeg(renderer, par1Block, (double) par2, (double) par3, (double) par4, BlockGrass.getIconSideOverlay());
			}
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 - 1, par3, par4, 4) && !connectNorth)
		{
			...
			f3 = (float) ((double) f8 * renderer.renderMaxY * renderer.renderMaxZ + (double) f11 * renderer.renderMaxY * (1.0D - renderer.renderMaxZ)
					+ (double) f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMaxZ) + (double) f9 * (1.0D - renderer.renderMaxY)
					* renderer.renderMaxZ);
			f4 = (float) ((double) f8 * renderer.renderMaxY * renderer.renderMinZ + (double) f11 * renderer.renderMaxY * (1.0D - renderer.renderMinZ)
					+ (double) f10 * (1.0D - renderer.renderMaxY) * (1.0D - renderer.renderMinZ) + (double) f9 * (1.0D - renderer.renderMaxY)
					* renderer.renderMinZ);
			f5 = (float) ((double) f8 * renderer.renderMinY * renderer.renderMinZ + (double) f11 * renderer.renderMinY * (1.0D - renderer.renderMinZ)
					+ (double) f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMinZ) + (double) f9 * (1.0D - renderer.renderMinY)
					* renderer.renderMinZ);
			f6 = (float) ((double) f8 * renderer.renderMinY * renderer.renderMaxZ + (double) f11 * renderer.renderMinY * (1.0D - renderer.renderMaxZ)
					+ (double) f10 * (1.0D - renderer.renderMinY) * (1.0D - renderer.renderMaxZ) + (double) f9 * (1.0D - renderer.renderMinY)
					* renderer.renderMaxZ);
			...
			this.renderFaceZNeg(renderer, par1Block, (double) par2, (double) par3, (double) par4, icon);
			...
			if(RenderBlocks.fancyGrass && icon.getIconName().equals("grass_side") && !renderer.hasOverrideBlockTexture())
			{
				...
				renderer.colorBlueBottomRight *= par7;
				renderer.colorBlueTopRight *= par7;
				this.renderFaceZNeg(renderer, par1Block, (double) par2, (double) par3, (double) par4, BlockGrass.getIconSideOverlay());
			}
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2 + 1, par3, par4, 5) && !connectSouth)
		{
			...
			f3 = (float) ((double) f9 * (1.0D - renderer.renderMinY) * renderer.renderMaxZ + (double) f8 * (1.0D - renderer.renderMinY)
					* (1.0D - renderer.renderMaxZ) + (double) f11 * renderer.renderMinY * (1.0D - renderer.renderMaxZ) + (double) f10 * renderer.renderMinY
					* renderer.renderMaxZ);
			f4 = (float) ((double) f9 * (1.0D - renderer.renderMinY) * renderer.renderMinZ + (double) f8 * (1.0D - renderer.renderMinY)
					* (1.0D - renderer.renderMinZ) + (double) f11 * renderer.renderMinY * (1.0D - renderer.renderMinZ) + (double) f10 * renderer.renderMinY
					* renderer.renderMinZ);
			f5 = (float) ((double) f9 * (1.0D - renderer.renderMaxY) * renderer.renderMinZ + (double) f8 * (1.0D - renderer.renderMaxY)
					* (1.0D - renderer.renderMinZ) + (double) f11 * renderer.renderMaxY * (1.0D - renderer.renderMinZ) + (double) f10 * renderer.renderMaxY
					* renderer.renderMinZ);
			f6 = (float) ((double) f9 * (1.0D - renderer.renderMaxY) * renderer.renderMaxZ + (double) f8 * (1.0D - renderer.renderMaxY)
					* (1.0D - renderer.renderMaxZ) + (double) f11 * renderer.renderMaxY * (1.0D - renderer.renderMaxZ) + (double) f10 * renderer.renderMaxY
					* renderer.renderMaxZ);
			...
			this.renderFaceZPos(renderer, par1Block, (double) par2, (double) par3, (double) par4, icon);
			...
			if(RenderBlocks.fancyGrass && icon.getIconName().equals("grass_side") && !renderer.hasOverrideBlockTexture())
			{
				...
				renderer.colorBlueBottomRight *= par7;
				renderer.colorBlueTopRight *= par7;
				this.renderFaceZPos(renderer, par1Block, (double) par2, (double) par3, (double) par4, BlockGrass.getIconSideOverlay());
			}
			...
			float par7)
	{
		...
		if(renderer.renderAllFaces || par1Block.shouldSideBeRendered(renderer.blockAccess, par2, par3, par4 + 1, 3) && !connectWest)
		{
			...
			tessellator.setColorOpaque_F(f11, f14, f17);
			icon = renderer.getBlockIcon(par1Block, renderer.blockAccess, par2, par3, par4, 3);
			this.renderFaceXNeg(renderer, par1Block, (double) par2, (double) par3, (double) par4, icon);
	 ...
	 * x, y, z, texture
	 */
	public void renderFaceYNeg(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6, Icon par8Icon)
	{
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * y, z, texture
	 */
	public void renderFaceYPos(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6, Icon par8Icon)
	{
		Tessellator tessellator = Tessellator.instance;
	 ...
	 */
	public void renderFaceXPos(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6, Icon par8Icon)
	{
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * Args: block, x, y, z, texture
	 */
	public void renderFaceXNeg(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6, Icon par8Icon)
	{
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * Args: block, x, y, z, texture
	 */
	public void renderFaceZNeg(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6, Icon par8Icon)
	{
		Tessellator tessellator = Tessellator.instance;
	 ...
	 * Args: block, x, y, z, texture
	 */
	public void renderFaceZPos(RenderBlocks renderer, Block par1Block, double par2, double par4, double par6, Icon par8Icon)
	{
		Tessellator tessellator = Tessellator.instance;
