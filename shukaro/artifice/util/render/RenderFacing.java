...
public class RenderFacing
{
    ...
    private static void renderFaceYNeg(RenderBlocks renderer, Block block, double x, double y, double z, Icon icon, boolean inverted, Tessellator tessellator)
    {
        ...
        double d4 = icon.getInterpolatedU(renderer.renderMaxX * 16.0D);
        double d5 = icon.getInterpolatedV(renderer.renderMinZ * 16.0D);
        double d6 = icon.getInterpolatedV(renderer.renderMaxZ * 16.0D);
        ...
        {
            d3 = icon.getInterpolatedU(renderer.renderMinZ * 16.0D);
            d5 = icon.getInterpolatedV(16.0D - renderer.renderMaxX * 16.0D);
            d4 = icon.getInterpolatedU(renderer.renderMaxZ * 16.0D);
            d6 = icon.getInterpolatedV(16.0D - renderer.renderMinX * 16.0D);
            d9 = d5;
            d10 = d6;
            d7 = d3;
            d8 = d4;
        ...
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMaxZ * 16.0D);
            d5 = icon.getInterpolatedV(renderer.renderMinX * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMinZ * 16.0D);
            d6 = icon.getInterpolatedV(renderer.renderMaxX * 16.0D);
            d7 = d4;
            d8 = d3;
            d3 = d4;
            d4 = d8;
        ...
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMinX * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMaxX * 16.0D);
            d5 = icon.getInterpolatedV(16.0D - renderer.renderMinZ * 16.0D);
            d6 = icon.getInterpolatedV(16.0D - renderer.renderMaxZ * 16.0D);
            d7 = d4;
            d8 = d3;
            d9 = d5;
            d10 = d6;
    ...
    private static void renderFaceZNeg(RenderBlocks renderer, Block block, double x, double y, double z, Icon icon, boolean inverted, Tessellator tessellator)
    {
        ...
        double d3 = icon.getInterpolatedU(renderer.renderMinX * 16.0D);
        double d4 = icon.getInterpolatedU(renderer.renderMaxX * 16.0D);
        double d5 = icon.getInterpolatedV(16.0D - renderer.renderMaxY * 16.0D);
        double d6 = icon.getInterpolatedV(16.0D - renderer.renderMinY * 16.0D);
        double d7;
        ...
        {
            d3 = icon.getInterpolatedU(renderer.renderMinY * 16.0D);
            d5 = icon.getInterpolatedV(16.0D - renderer.renderMinX * 16.0D);
            d4 = icon.getInterpolatedU(renderer.renderMaxY * 16.0D);
            d6 = icon.getInterpolatedV(16.0D - renderer.renderMaxX * 16.0D);
            d9 = d5;
            d10 = d6;
            d7 = d3;
            d8 = d4;
        ...
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMaxY * 16.0D);
            d5 = icon.getInterpolatedV(renderer.renderMaxX * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMinY * 16.0D);
            d6 = icon.getInterpolatedV(renderer.renderMinX * 16.0D);
            d7 = d4;
            d8 = d3;
            d3 = d4;
            d4 = d8;
        ...
        else if (renderer.uvRotateEast == 3)
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMinX * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMaxX * 16.0D);
            d5 = icon.getInterpolatedV(renderer.renderMaxY * 16.0D);
            d6 = icon.getInterpolatedV(renderer.renderMinY * 16.0D);
            d7 = d4;
            d8 = d3;
            d9 = d5;
            d10 = d6;
    ...
    private static void renderFaceXNeg(RenderBlocks renderer, Block block, double x, double y, double z, Icon icon, boolean inverted, Tessellator tessellator)
    {
        ...
        double d3 = icon.getInterpolatedU(renderer.renderMinZ * 16.0D);
        double d4 = icon.getInterpolatedU(renderer.renderMaxZ * 16.0D);
        double d5 = icon.getInterpolatedV(16.0D - renderer.renderMaxY * 16.0D);
        double d6 = icon.getInterpolatedV(16.0D - renderer.renderMinY * 16.0D);
        double d7;
        ...
        {
            d3 = icon.getInterpolatedU(renderer.renderMinY * 16.0D);
            d5 = icon.getInterpolatedV(16.0D - renderer.renderMaxZ * 16.0D);
            d4 = icon.getInterpolatedU(renderer.renderMaxY * 16.0D);
            d6 = icon.getInterpolatedV(16.0D - renderer.renderMinZ * 16.0D);
            d9 = d5;
            d10 = d6;
            d7 = d3;
            d8 = d4;
        ...
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMaxY * 16.0D);
            d5 = icon.getInterpolatedV(renderer.renderMinZ * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMinY * 16.0D);
            d6 = icon.getInterpolatedV(renderer.renderMaxZ * 16.0D);
            d7 = d4;
            d8 = d3;
            d3 = d4;
            d4 = d8;
        ...
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMinZ * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMaxZ * 16.0D);
            d5 = icon.getInterpolatedV(renderer.renderMaxY * 16.0D);
            d6 = icon.getInterpolatedV(renderer.renderMinY * 16.0D);
            d7 = d4;
            d8 = d3;
    ...
    private static void renderFaceXPos(RenderBlocks renderer, Block block, double x, double y, double z, Icon icon, boolean inverted, Tessellator tessellator)
    {
        ...
        {
            d3 = icon.getInterpolatedU(16.0D - renderer.renderMaxY * 16.0D);
            d5 = icon.getInterpolatedV(renderer.renderMaxZ * 16.0D);
            d4 = icon.getInterpolatedU(16.0D - renderer.renderMinY * 16.0D);
            d6 = icon.getInterpolatedV(renderer.renderMinZ * 16.0D);
            d7 = d4;
            d8 = d3;
            d3 = d4;
            d4 = d8;
