...
/**
 * This is a very simple static singleton registry class, used to send ticks to
 * active multiblocks. Register when your multiblock is created and unregister
 * it when it loses its last connected block.
 */
public class MultiblockRegistry
{
     ...
     * 
     * @param reactor
     *            The machine that should begin receiving world ticks.
     */
    ...
    /**
     * Unregister a multiblock machine so that it no longer receives world
     * ticks.
     * 
     * @param reactor
     *            The machine that should no longer receive world ticks.
     */
