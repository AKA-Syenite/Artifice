...
public class BlockMarbleSlab extends BlockHalfSlab
{
    ...
    private ConnectedTextureBase paver = new SlabConnectedTexture(ConnectedTextures.MarblePaver);
    private ConnectedTextureBase antipaver = new SlabConnectedTexture(ConnectedTextures.MarbleAntipaver);
