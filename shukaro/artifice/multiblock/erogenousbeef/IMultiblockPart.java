 ...
 * implemented on a TileEntity. Better yet, derive from
 * MultiblockTileEntityBase, which does all the hard work for you.
 * 
...
public interface IMultiblockPart
{
    ...
    /**
     * Called when this block is merged from its current controller into a new
    ...
    /**
     * Set the graph-traversal (walk) distance from the reference block to this
     * block.
     * 
     * @param newDistance
     *            The new current distance from the reference block to this
     *            block.
     */
     ...
     * 
     * @return The graph-traversal (walk) distance from the reference block to
     *         this block.
     */
    ...
    /**
     * Dispatches a packet across the wire and marks this block for a world
     * update. The default implementation simply calls getDescriptionPacket().
    ...
    /**
     * Called when a machine is fully assembled from a broken state. Use this to
     * set metadata if you want to change your blocks' appearance, as well as
     * initialize any specialized logic in your tile entities. Note that, for
     * non-square machines, the min/max coordinates may not actually be part of
     * the machine! They form an outer bounding box for the whole machine
     * itself.
     * 
     * @param machineMinCoords
     *            The minimum x,y,z coordinates present in the machine.
     * @param machineMaxCoords
     *            the maximum x,y,z coordinates present in the machine.
     */
    public void onMachineAssembled();
    
    /**
     * Called when the machine is broken, generally due to the removal of a
     * block.
     */
    ...
    /**
     * @return True if this block can be used as a piece of the machine's frame.
     *         (Outer edges)
     */
    public boolean isGoodForFrame();
    
    /**
     * @return True if this block can be used on the north, east, south or west
     *         faces of the machine, inside of the frame.
     */
    public boolean isGoodForSides();
    
    /**
     * @return True if this block can be used on the top face of the machine,
     *         inside of the frame.
     */
    public boolean isGoodForTop();
    
    /**
     * @return True if this block can be used on the bottom face of the machine,
     *         inside of the frame.
     */
    public boolean isGoodForBottom();
    
    /**
     * @return True if this block can be used inside the machine; not on any
     *         faces or the frame.
     */
    ...
    // Block events
    /**
     * Should be called by the block when it receives an onBlockAdded event to
     * an IMultiblockPart tile entity.
     * 
     * @param world
     *            The world in which this tile entity exists.
     * @param x
     *            The x coordinate at which this tile entity exists.
     * @param y
     *            The y coordinate at which this tile entity exists.
     * @param z
     *            The z coordinate at which this tile entity exists.
     */
