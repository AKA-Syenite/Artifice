...
public class BlockBasalt extends BlockArtifice
{
    ...
    private ConnectedTextureBase paver = new SolidConnectedTexture(ConnectedTextures.BasaltPaver);
    private ConnectedTextureBase antipaver = new SolidConnectedTexture(ConnectedTextures.BasaltAntipaver);
