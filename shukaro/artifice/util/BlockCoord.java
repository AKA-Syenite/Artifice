...
public class BlockCoord implements Comparable
{
	...
	public static final BlockCoord[] nearbyOffsets = { new BlockCoord(-1,1,1), new BlockCoord(0,1,1), new BlockCoord(1,1,1), 
													   new BlockCoord(-1,0,1), new BlockCoord(0,0,1), new BlockCoord(1,0,1),
