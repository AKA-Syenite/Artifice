...
public class ArtificeTooltips
{
    ...
    private static void initBlockTooltips()
    {
        ...
        if (ArtificeConfig.enableFrames.getBoolean(true))
        {
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockGlassWall.blockID, 0, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockGlassWall.getResistance(0));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockGlassWall.blockID, 1, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockGlassWall.getResistance(1));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockGlassWall.blockID, 2, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockGlassWall.getResistance(2));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockGlassWall.blockID, 3, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockGlassWall.getResistance(3));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockReinforced.blockID, 0, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockReinforced.getResistance(0));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockReinforced.blockID, 1, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockReinforced.getResistance(1));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockReinforced.blockID, 2, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockReinforced.getResistance(2));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockReinforced.blockID, 3, FormatCodes.Italic.code + "Resistance: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + (int) ArtificeBlocks.blockReinforced.getResistance(3));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockScaffold.blockID, 0, FormatCodes.Italic.code + "Max Overhang: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + ArtificeBlocks.blockScaffold.getOverhang(0));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockScaffold.blockID, 1, FormatCodes.Italic.code + "Max Overhang: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + ArtificeBlocks.blockScaffold.getOverhang(1));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockScaffold.blockID, 2, FormatCodes.Italic.code + "Max Overhang: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + ArtificeBlocks.blockScaffold.getOverhang(2));
            ...
            ArtificeRegistry.registerTooltip(ArtificeBlocks.blockScaffold.blockID, 3, FormatCodes.Italic.code + "Max Overhang: " + FormatCodes.Reset.code + FormatCodes.Aqua.code + ArtificeBlocks.blockScaffold.getOverhang(3));
